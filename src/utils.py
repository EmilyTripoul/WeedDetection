...
def openDatabase(databaseName_):      
    global databaseName, databaseFolder, dataInputFolder, dataInputFolder, dataOutputFolder, dataTmpFolder
...
def readPlantInfo(filePath):    
    plantInfoList=[]
    with open(getDataFilepathFromFilepath(filePath)) as csvfile:
